anychart.onDocumentReady(function() {
    // load data
    anychart.data.loadJsonFile("africaBubble.json",
    function (data) {
      ...
      // series 2
      var series2 = chart.bubble(africa).name("Africa");
      series2.normal().fill("rgb(96,210,230)", 0.8);
      series2.hovered().fill("rgb(96,210,230)", 0.8);
      series2.selected().fill("rgb(96,210,230)", 0.8);
