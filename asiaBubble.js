anychart.onDocumentReady(function() {
    // load data
    anychart.data.loadJsonFile("asiaBubble.json",
    function (data) {
      ...
      */
      ...
      // series 2
      var series2 = chart.bubble(asia).name("Asia");
      series2.normal().fill("rgb(245,80,100)", 0.8);
      series2.hovered().fill("rgb(245,80,100)", 0.8);
      series2.selected().fill("rgb(245,80,100)", 0.8);
